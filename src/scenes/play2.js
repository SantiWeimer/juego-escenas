...
create() {
  ...
  platforms.create(120, 440, 'plataforma');
  platforms.create(650, 450, 'plataforma2');

   
  
  platforms.create(350, 320, 'plataforma3');


  platforms.create(500, 230, 'plataforma3');
   
  platforms.create(30, 250, 'plataforma3');
 ...
 //monedas
  ...
  var nivelText = this.add.text(16, 16, 'Nivel: 1', { fontFamily: 'Times', fontStyle: 'italic', fontSize: '32px', fill: '#D9120C' });
